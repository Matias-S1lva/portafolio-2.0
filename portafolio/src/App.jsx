...
const colores = [ {background:"var(--red-sweet)"}, {background:"var(--blue-light)"}, {background:"var(--hover)"}]
let indice = -1
const changeColor = () => {
  if(indice === 2 )
    indice = -1
    ...
    <>
      ...
      <Section>
        {cards.map((card) => (
          ...
          <Card url={card.url} foto={card.foto} title={card.title} color={changeColor()} description={card.description}/>
